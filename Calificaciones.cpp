...
main()
{
    ...
    printf ("Por favor escriba sus calificaciones usando A, B, C, D, E o F. Segun corresponda\n");
    ...
    else if (V1=='F')
    {
        ...
        {
        printf ("Calificacion 1 reprobatoria. SUERTE EN EL EXTRAORDINARIO\n");
    }
    ...
    else if (V2=='F')
    {
        ...
        {
        printf ("Calificacion 2 reprobatoria. SUERTE EN EL EXTRAORDINARIO\n");
    }
    ...
    else if (V3=='F')
    {
        ...
        {
        printf ("Calificacion 3 reprobatoria. SUERTE EN EL EXTRAORDINARIO\n");
    }
